...
- graphkit_data/case24_ieee_rts_s10000_droop_mprange_mqrange
...
- Pd, Qd, Pg, Qg, Vm, Va
- PQ, PV, REF
- mp_droop, mq_droop, frequency_deadband, voltage_deadband
...
- train: scenarios [0..7999]
- val: scenarios [8000..8999]
- test: scenarios [9000..9999]
...
- Treat mp_droop, mq_droop, frequency_deadband, and voltage_deadband as required node input features.
